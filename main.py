...
@app.route("/")
def main():
    return "<h1>Cześć! Witaj na mojej stronie!</h1><h2><a href='/random_fact'>Zobacz losowy fakt na temat zależności technologicznych</a></h2><h2><a href='/coin_flip'>Rzuć monetą</a></h2>"

@app.route("/random_fact")
def fact():
    return f"<p>{choice(facts_list)}</p><br><p><a href='/random_fact'>Nowy fakt</a></p><h4><a href='/'>Powrót</a></h4>"

@app.route("/coin_flip")
def coin():
    return f"<h3>{choice(coin_outcomes)}</h3><br><p><a href='/coin_flip'>Rzuć jeszcze raz</a></p><h4><a href='/'>Powrót</a></h4>"
